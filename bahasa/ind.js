...
exports.noregis = () => {
	return`*「 PENDAFTARAN 」*\n\n*Cara daftar ${prefix}daftar nama|umur* \n*contoh ${prefix}daftar NuyFaa|15*`
}

exports.rediregis = () => {
	return`*「 SUDAH TERDAFTAR 」*\n\n*Kamu sudah terdaftar di database Manca-botツ*`
}
...
exports.bug = () => {
	return`*Masalah telah di laporkan ke owner NuyFaaツ, Laporan palsu atau main² tidak akan ditanggapi.*`
}
